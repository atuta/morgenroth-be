...
class UserService:
    ...
    def create_organization_record(data, logo_file=None):
        """
        Inserts a new OrganizationDetail record.
        :param data: Dictionary containing name, address, etc.
        :param logo_file: The uploaded file object (from request.FILES)
        """
        try:
            ...
            # We don't pass org_uuid; it's autogenerated by the model
            ...
            Logs.atuta_technical_logger(f"SUCCESS: Organization '{name}' created with UUID {org.org_uuid}")
            ...
            Logs.atuta_technical_logger(f"ERROR creating organization record: {str(e)}")
            return {
                "status": "error",
